    ...
    <form action="{{ route('clientes.update', $clientes) }}" method="POST">
        ...
        <div class="row p-2">
            <div class="col-2 d-flex flex-column">
                ...
                <input class="form-control" type="text" value="{{ $clientes->codBomControle }}" id="codigo" name="codBomControle" required>
            </div>
            <div class="col-3 d-flex flex-column">
                <label class="form-label">CNPJ / CPF <font color="#FF0000">*</font></label>
                <input class="form-control" type="text" id="documento" value="{{ $clientes->cnpjCpf }}" name="cnpjCpf" maxlength="18" required>
            </div>
        </div>
        <div class="row p-2">
            <div class="col d-flex flex-column">
                <label class="form-label">Razão Social <font color="#FF0000">*</font></label>
                <input class="form-control" type="text" value="{{ $clientes->razaoSocial }}" id="razao_social" name="razaoSocial" maxlength="70" required>
            </div>
            <div class="col d-flex flex-column">
                <label class="form-label">Nome Fantasia</label>
                <input class="form-control" type="text" value="{{ $clientes->nomeFantasia }}" id="nome_fantasia" name="nomeFantasia" maxlength="70">
            </div>
        </div>
        <div class="row p-2">
            <div class="col-3 d-flex flex-column">
                <label class="form-label">Nome Responsável</label>
                <input class="form-control" type="text" value="{{ $clientes->nomeResponsavel }}" id="nomeResponsavel" name="nomeResponsavel" maxlength="70">
            </div>
            <div class="col-3 d-flex flex-column">
                <label class="form-label" for="phoneNumberInput">Telefone / Celular</label>
                <input class="form-control" type="text" value="{{ $clientes->telefone }}" id="telefone" name="telefone" maxlength="15">
            </div>
            <div class="col-6 d-flex flex-column">
                <label class="form-label">E-mail</label>
                <input class="form-control" type="text" value="{{ $clientes->email }}" id="email" name="email" maxlength="70">
            </div>
        </div>
        <!-- Dados do Sistema
        <div class="row p-2">
        ...
        <div class="tab-content" id="nav-tabContent1">
            <div class="tab-pane content1 fade show active cloned-form" id="nav-s1" role="tabpanel" aria-labelledby="nav-s-tab1">
                ...
                <div class="btn-form p-2">
                    <button class="btn btn-success" id="cadastrar">Salvar</button>
                    <a href="{{ route('home') }}" class="btn btn-danger" id="voltar">Cancelar</a>
                </div>
                <div class="row">
                    <div class="col">
                        <hr>
